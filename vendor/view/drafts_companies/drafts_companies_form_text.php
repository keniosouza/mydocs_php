...
<div class="col-md-12">
    ...
    <div class="card shadow-sm animate slideIn">
        ...
        <form class="card-body" role="form" id="DraftsCompaniesFormText">
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-end mt-3">
                    ...
                    <button type="button" class="btn btn-success" onclick="sendRequest('DraftsCompaniesFormText', '', true, '', '', '', 'Aguarde...', 'blue', 'circle', 'sm', true)">
            ...
            <input type="hidden" name="ACTION" value="DRAFTS_COMPANIES_SAVE_TEXT" />
